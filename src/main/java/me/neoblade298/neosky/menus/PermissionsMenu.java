...
public class PermissionsMenu extends CoreInventory {
    public PermissionsMenu(Player player) {
        ...
        contents[14] = CoreInventory.createButton(Material.YELLOW_CONCRETE, Component.text("Members", NamedTextColor.AQUA));
        contents[15] = CoreInventory.createButton(Material.GREEN_CONCRETE, Component.text("Officers", NamedTextColor.AQUA));
