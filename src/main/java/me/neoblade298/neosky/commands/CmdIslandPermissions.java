...
import me.neoblade298.neosky.menus.PermissionsMenu;

public class CmdIslandPermissions extends Subcommand {
    public CmdIslandPermissions(String key, String desc, String perm, SubcommandRunner runner) {
